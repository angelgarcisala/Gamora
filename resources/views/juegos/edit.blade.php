...
>
    ...
    >
        ...
        <button
            ...
            @click.prevent="$refs.mediaInput.click()"
        ></button>
    </div>
                    ...
                    <div class="bg-gray-800/50 p-6 rounded-xl shadow-lg space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                class="mt-1 block w-full bg-gray-700/40 placeholder-gray-400 text-white text-base border-gray-700 focus:border-purple-500 focus:ring-purple-500 rounded-md shadow-sm p-3"
