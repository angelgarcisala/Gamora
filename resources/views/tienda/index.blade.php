...
<x-app-layout>
  <x-self.base>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <h1 class="text-3xl font-bold text-white mb-6">Tienda</h1>

      @if($juegos->isEmpty())
        <p class="text-purple-200">No hay juegos disponibles.</p>
      @else
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          @foreach($juegos as $juego)
            @php
              // Buscar thumbnail (primera imagen tipo 'imagen') o poner placeholder si no existe.
